...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_nationality_process_step')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_nationality_process_step')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.nationality_process_steps.update',['nationality_process_step_id'=>$nationalityProcessStep->id])}}"
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[ar]"
                                               ...
                                               id="title_ar"
                                               value="{{  $nationalityProcessStep->getTranslation('title','ar') }}">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title[en]"
                                               ...
                                               id="title_en"
                                               value="{{$nationalityProcessStep->getTranslation('title','en') }}">

                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <x-admin.text-area-input name="description" :value="$nationalityProcessStep->description" rows="5">

                                    </x-admin.text-area-input>
                                </div>

                                <div class="col-sm-6 col-md-6">
                                    <x-admin.checkbox-input name="status" :value="$nationalityProcessStep->status"
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.nationality_process_steps.index') }}"
