            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="fs-16 font-weight-normal text-center">@lang('admin/datatable.client_report') </h3>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="table-responsive">
                                <livewire:admin.user-table :startDate="$startDate" :endDate="$endDate" :state="$state"/>
                            </div>
                        </div>
                    </div>
                </div>
