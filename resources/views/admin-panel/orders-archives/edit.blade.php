...
@section('content')
    <div class="side-app">
            ...
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a
                            href="{{route('admin.orders_archives.index',['order_id' => $order])}}" class="">
                            @lang('admin/dashboard.menus.orders_archives')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_order_archive')
                    </li>
                </ol>
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.orders_archives.update',['orders_archive_id' => $order_archive->id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-input name="title"
                                                        value="{{$order_archive->title}}"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-area-input name="description"
                                                             value="{{$order_archive->description}}"></x-admin.text-area-input>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.multi-image-input gallery-name-key="images"
                                                               :images="json_decode($order_archive->images)">
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.orders_archives.index',['order_id' => $order]) }}"
