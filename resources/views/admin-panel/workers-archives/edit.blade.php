...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_worker_archive')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_worker_archive')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.workers_archives.update',['worker_archive_id' => $worker_archive->id])}}"
              enctype="multipart/form-data"
              class="">

            @csrf

            <input type="hidden" name="workerArchives_id" value="{{ $worker_archive->id}}">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-input name="title" value="{{$worker_archive->title}}"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-area-input name="description" value="{{$worker_archive->description}}" ></x-admin.text-area-input>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                 ...
                                 <div class="col-sm-12 col-md-12">
                                    <x-admin.multi-image-input gallery-name-key="images" :images="json_decode($worker_archive->images)">

                                    </x-admin.multi-image-input>
                                </div>
