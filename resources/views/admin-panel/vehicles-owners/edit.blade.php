...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.vehicles.owners.index')}}" class="">
                            @lang('admin/dashboard.menus.vehicles_owners')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_owner')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25">@lang('admin/datatable.buttons.u_owner')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.vehicles.owners.update',['vehicles_owner_id'=>$admin->id])}}"
              enctype="multipart/form-data"
              class="">
            @csrf

            <input type="hidden" name="VehicleOwner_id" value="{{$admin->id}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="material-switch">
                                            <input id="status" name="status"
                                                   type="checkbox" @checked($admin->status) >
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.vehicles.owners.index') }}" class="btn btn-danger "> <span
                    ...
                    <div class="card">
                        ...
                        <div class="form-group p-2">
                            <input type="file" id="image" name="image" class="dropify input_field p-5"
                                   data-default-file="{{  $admin->imageUrl }}"
                                   data-height="180"/>
                        </div>
                    </div>
                </div>
...
'request'=>'App/Http/Requests/Admin/VehiclesOwners/UpdateVehiclesOwnerRequest'])
