...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    <li class="breadcrumb-item1"><a href="{{route('admin.dashboard.home')}}" class=""><i class="fe fe-home me-2" aria-hidden="true"></i>
                    ...
                    <li class="breadcrumb-item1 active"> @lang('admin/datatable.buttons.c_vehicle_type')</li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25">@lang('admin/datatable.buttons.c_vehicle_type')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.vehicles.types.store')}}"
...
'request'=>'App/Http/Requests/Admin/VehiclesTypes/CreateVehiclesTypeRequest'])
