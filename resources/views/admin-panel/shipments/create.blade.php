...
@section('content')
    <div class="side-app">
            ...
            <div class="page-leftheader">
                <ol class="breadcrumb1">
                    <li class="breadcrumb-item1"><a href="{{route('admin.dashboard.home')}}" class=""><i
                                class="fe fe-home me-2" aria-hidden="true"></i>
                    ...
                    <li class="breadcrumb-item1 active"> @lang('admin/datatable.buttons.c_shipment')</li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25">@lang('admin/datatable.buttons.c_shipment')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off" action="{{route('admin.shipments.store')}}"
              enctype="multipart/form-data"
              class="">
            @csrf
<input type="hidden" id="price_per_ton" value="0">
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <label for="tracking_number" class="form-label">@lang('admin/datatable.tracking_number') <span
                                ...
                                <div class="col-sm-6 col-md-6"> {{-- Shipment Start Date --}}
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="start_date" class="form-control fc-datepicker"
                                ...
                                <div class="col-sm-6 col-md-6"> {{-- Shipment Start Time --}}
                                    ...
                                    <div class="d-flex">
                                        <div class="input-group wd-150">
                                            ...
                                            <input class="form-control" name="start_time" id="tp3" placeholder="Set time" type="text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="trailer_id" id="owner_ids"
                                            ...
                                            @foreach($trailers as $trailer)
                                                <option value="{{$trailer->id}}">{{$trailer->name}}
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="destination_id" id="destination_id"
                                                class="form-control SlectBox owner_id_input">
                                            <option value="0">-- تحديد الوجهه بناء على العميل --</option>
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.shipments.index') }}" class="btn btn-danger "> <span
        ...
        @push('scripts')
            @javascript('destinations_by_client_id_url', route('admin.shipments.ajax.clients.destinations'))
