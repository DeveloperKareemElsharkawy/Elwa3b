...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_vehicle')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25">@lang('admin/datatable.buttons.u_vehicle')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.vehicles.update',['vehicles_id'=>$vehicle->id])}}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="vehicle_type_id" id="vehicle_type_id"
                                            ...
                                            @foreach($vehiclesTypes as $vehiclesType)
                                                <option
                                                    @selected( $vehicle->vehicle_type_id == $vehiclesType->id) value="{{$vehiclesType->id}}">{{$vehiclesType->name}}</option>
                                    ...
                                    <div class="form-group">
                                        <label for="car_capital"
                                               class="form-label">@lang('admin/datatable.car_capital') <span
                                                class="text-red">*</span> </label>
                                        <input type="text" name="car_capital"
                                               class="form-control mb-3 input_field"
                                               placeholder=" car_capital"
                                               id="car_capital"
                                               value="{{ $vehicle->car_capital }}">
                                ...
                                <div class="owners-group mb-3"> {{-- Owners Group --}}
                                    @foreach($vehicle->owners_percentage as $owner_percentage)
                                        <div class="row owners owner-item-{{$loop->index}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="owners[0][owner_id]" id="owner_ids"
                                                        ...
                                                        @foreach($owners as $owner)
                                                            <option
                                                                @selected($owner->id == $owner_percentage->owner_id) value="{{$owner->id}}">{{$owner->name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control percent_input"
                                                               ...
                                                               value="{{$owner_percentage->percentage}}"
                                                               aria-describedby="inputGroupPrepend2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div
                                                class="col-sm-1 col-md-1 {{!$loop->first ? : 'd-none'}}  delete-owner-button">
                                                <button type="button" id="delete-owner-{{$loop->index}}"
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="indigo"
                                                       class="colorinput-input" @checked($vehicle->color == 'indigo')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="purple"
                                                       class="colorinput-input" @checked($vehicle->color == 'purple')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="pink"
                                                       class="colorinput-input" @checked($vehicle->color == 'pink')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="red"
                                                       class="colorinput-input" @checked($vehicle->color == 'red')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="lime"
                                                       class="colorinput-input" @checked($vehicle->color == 'lime')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="green"
                                                       class="colorinput-input" @checked($vehicle->color == 'green')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="teal"
                                                       class="colorinput-input" @checked($vehicle->color == 'teal')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="black"
                                                       class="colorinput-input" @checked($vehicle->color == 'black')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="white"
                                                       class="colorinput-input" @checked($vehicle->color == 'white')>
                    ...
                    <div class="card">
                        ...
                        <div class="form-group p-2">
                            <input type="file" id="image" name="image" class="dropify input_field p-5"
                                   data-default-file="{{ asset($vehicle->imageUrl) }}"
                                   data-height="180"/>
                        </div>
                    </div>
                </div>
        ...
        @push('scripts')
            ...
            @javascript('auctionImagesList', json_decode($vehicle->gallery))
            @javascript('license_start_date', $vehicle->license_start_date->format('m/d/Y'))
            @javascript('license_end_date', $vehicle->license_end_date->format('m/d/Y'))
            ...
            <script>
                $(document).ready(function () {
                    $("#license_start_date").datepicker("setDate", license_start_date).datepicker("refresh");
                    $("#license_end_date").datepicker("setDate", license_end_date).datepicker("refresh");
                });

            </script>

    @include('vendor.lrgt.ajax_script', ['form' => '#myform','name_class'=>'',
'request'=>'App/Http/Requests/Admin/Vehicles/UpdateVehicleRequest'])
