...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_slider')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_slider')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.slider.update',['slider_id'=>$slider->id])}}"
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group"><label
                                        ...
                                        <textarea data-skip-name="true"
                                                  ...
                                                  spellcheck="false">{{  $slider->getTranslation('description','ar') }}</textarea>
                                     </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group"><label
                                        ...
                                        <textarea data-skip-name="true"
                                                  ...
                                                  rows="4"
                                                  placeholder="{{trans('admin/datatable.input_placeholder', ['attribute' => trans('admin/datatable.description')])}}"
                                                  spellcheck="false">{{  $slider->getTranslation('description','en') }}</textarea>
                                     </div>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.drop-down-input :selected="$slider->target" name="target" :options="[
                                ...
                                <div class="col-sm-12 col-md-12" id="url_target">
                                    <x-admin.text-input name="url" :value="$slider->url"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12" id="category_target">
                                    <x-admin.drop-down-input name="category" :value="$slider->category"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="worker" id="worker" class="select2-show-search form-control SlectBox "
                                            ...
                                            @foreach($workers as $worker)
                                                <option @checked($slider->worker_id == $worker->id) value="{{$worker->id}}">{{$worker->name}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.checkbox-input name="status"
                                                            :value="$slider->status"></x-admin.checkbox-input>
                                </div>
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <x-admin.image-input name="image" :default-value="$slider->imageUrl"></x-admin.image-input>
                </div>
