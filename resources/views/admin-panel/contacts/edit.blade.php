...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_category')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_category')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.categories.update',['category_id'=>$category->id])}}"
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="indigo"
                                                       class="colorinput-input" @checked($category->color == 'indigo')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="purple"
                                                       class="colorinput-input" @checked($category->color == 'purple')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="pink"
                                                       class="colorinput-input" @checked($category->color == 'pink')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="red"
                                                       class="colorinput-input" @checked($category->color == 'red')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="lime"
                                                       class="colorinput-input" @checked($category->color == 'lime')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="green"
                                                       class="colorinput-input" @checked($category->color == 'green')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="teal"
                                                       class="colorinput-input" @checked($category->color == 'teal')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="black"
                                                       class="colorinput-input" @checked($category->color == 'black')>
                                        ...
                                        <div class="col-auto">
                                            <label class="colorinput">
                                                <input name="color" type="radio" value="white"
                                                       class="colorinput-input" @checked($category->color == 'white')>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="material-switch">
                                            <input id="status" name="status"
                                                   type="checkbox" @checked($category->status) >
                    ...
                    <div class="card">
                        ...
                        <div class="form-group p-2">
                            <input type="file" id="image" name="image" class="dropify input_field p-5"
                                   data-default-file="{{  $category->imageUrl }}"
                                   data-height="180"/>
                        </div>
                    </div>
                </div>
