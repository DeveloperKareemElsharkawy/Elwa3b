...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.nationalities.index')}}" class="">
                            @lang('admin/dashboard.menus.nationalities')</a>
                    </li>
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_nationality')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_nationality')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.nationalities.update',['nationality_id'=>$nationality->id])}}"
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[ar]"
                                               ...
                                               placeholder="name"
                                               id="name_ar"
                                               value="{{  $nationality->getTranslation('name','ar') }}">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[en]"
                                               ...
                                               placeholder="name_en"
                                               id="name_en"
                                               value="{{  $nationality->getTranslation('name','en') }}">

                                    </div>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.multi-select-input name="processSteps" :options="$processSteps"
                                                                key-of-value="title"
                                                                :selected-values="$nationality->processSteps->pluck('id')->toArray()"
