...
@section('content')
    <div class="side-app">
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-30">@lang('admin/datatable.buttons.c_client')</h1>
        </div>
        <form method="post" id="myform" action="{{route('admin.clients.store')}}" enctype="multipart/form-data"
              class="">
            @csrf
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-4" placeholder="Textarea" id="address" name="address"
                                                  rows="3"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="destinations-group mb-3"> {{-- Owners Group --}}
                                    ...
                                    <div class="row destinations destination-item-0">
                                        <div class="col-sm-4 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control from_where"
                                                       name="destinations[0][from_where]" id="from_where"
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control to_where"
                                                       name="destinations[0][to_where]" id="to_where"
                                                       aria-describedby="inputGroupPrepend2">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-1 col-md-1 d-none delete-destination-button">
                                            <button type="button" id="delete-destination-0"
                                                    class="delete-destination btn btn-icon btn-md mt-6 btn-danger"><i
...
'request'=>'App/Http/Requests/Admin/Client/CreateClientRequest','on_start'=>false])
