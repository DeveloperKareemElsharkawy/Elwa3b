...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1 active">  @lang('admin/datatable.buttons.u_admin')
                    </li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25"> @lang('admin/datatable.buttons.u_admin')</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.system.users.update',['system_user_id'=>$admin->id])}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.multi-select-input name="roles" :options="$roles"
                                                                :selected-values="$admin->roles->pluck('id')->toArray()"
