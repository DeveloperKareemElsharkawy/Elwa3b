...
@section('content')
    <div class="side-app">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb1">
                    ...
                    <li class="breadcrumb-item1"><a href="{{route('admin.dashboard.home')}}" class="">
                            {{trans('admin/datatable.buttons.u_driver')}}</a>
                    </li>

                    <li class="breadcrumb-item1 active">{{trans('admin/datatable.buttons.u_driver')}}</li>
                </ol>
        ...
        <div class="text-center mb-5">
            <h1 class="page-title mb-0 text-primary  fs-25">تعديل دور الإداره</h1>
        </div>
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.drivers.update',['driver_id'=>$admin->id])}}"
              enctype="multipart/form-data"
              class="">
            @csrf

            <input type="hidden" name="driver_id" value="{{$admin->id}}">
