...
@section('content')
    <div class="side-app">
        ...
        <form method="post" id="myform" autocomplete="off"
              action="{{route('admin.users_archives.update',['user_archive_id' => $user_archive->id])}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-input name="title"
                                                        value="{{$user_archive->title}}"></x-admin.text-input>
                                </div>

                                <div class="col-sm-12 col-md-12">
                                    <x-admin.text-area-input name="description"
                                                             value="{{$user_archive->description}}"></x-admin.text-area-input>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <x-admin.multi-image-input gallery-name-key="images"
                                                               :images="json_decode($user_archive->images)">
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-footer text-center card-form-footer">
                            ...
                            <a href="{{ route('admin.users_archives.index',['user_id' => $user]) }}"
